...
console.log('👤 Creating Test User with Gmail');
console.log('=================================');
...
async function createTestUser() {
  try {
    // Gunakan email Gmail yang lebih standar
    const testEmail = 'admin.deliserdang@gmail.com';
...
async function testMultipleRegistrations() {
  const testUsers = [
    ...
    { email: 'user.deliserdang@gmail.com', password: 'user123456' },
    { email: 'test.deliserdang@gmail.com', password: 'test123456' }
  ];
