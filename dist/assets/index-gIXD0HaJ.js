 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ut(i){try{return(i.startsWith("http://")||i.startsWith("https://")?new URL(i).hostname:i).endsWith(".cloudworkstations.dev")}catch{return!1}}async function br(i){return(await fetch(i,{credentials:"include"})).ok}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const va="FirebaseError";class _e extends Error{constructor(e,n,s){super(n),this.code=e,this.customData=s,this.name=va,Object.setPrototypeOf(this,_e.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,xt.prototype.create)}}class xt{constructor(e,n,s){this.service=e,this.serviceName=n,this.errors=s}create(e,...n){const s=n[0]||{},o=`${this.service}/${e}`,c=this.errors[e],l=c?Ea(c,s):"Error",I=`${this.serviceName}: ${l} (${o}).`;return new _e(o,I,s)}}function Ea(i,e){return i.replace(Ta,(n,s)=>{const o=e[s];return o!=null?String(o):`<${s}?>`})}const Ta=/\{\$([^}]+)}/g;function Sa(i){for(const e in i)if(Object.prototype.hasOwnProperty.call(i,e))return!1;return!0}function Ge(i,e){if(i===e)return!0;const n=Object.keys(i),s=Object.keys(e);for(const o of n){if(!s.includes(o))return!1;const c=i[o],l=e[o];if(Ns(c)&&Ns(l)){if(!Ge(c,l))return!1}else if(c!==l)return!1}for(const o of s)if(!n.includes(o))return!1;return!0}function Ns(i){return i!==null&&typeof i=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bc="firebase-heartbeat-database",Cc=1,Dt="firebase-heartbeat-store";let Qn=null;function Or(){return Qn||(Qn=Wa(bc,Cc,{upgrade:(i,e)=>{switch(e){case 0:try{i.createObjectStore(Dt)}catch(n){console.warn(n)}}}}).catch(i=>{throw Oe.create("idb-open",{originalErrorMessage:i.message})})),Qn}async function Pc(i){try{const n=(await Or()).transaction(Dt),s=await n.objectStore(Dt).get(Dr(i));return await n.done,s}catch(e){if(e instanceof _e)pe.warn(e.message);else{const n=Oe.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});pe.warn(n.message)}}}async function xs(i,e){try{const s=(await Or()).transaction(Dt,"readwrite");await s.objectStore(Dt).put(e,Dr(i)),await s.done}catch(n){if(n instanceof _e)pe.warn(n.message);else{const s=Oe.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});pe.warn(s.message)}}}function Dr(i){return`${i.name}!${i.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fn=new fi("@firebase/auth");function xc(i,...e){fn.logLevel<=O.WARN&&fn.warn(`Auth (${ht}): ${i}`,...e)}function on(i,...e){fn.logLevel<=O.ERROR&&fn.error(`Auth (${ht}): ${i}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ft{constructor(e,n){this.shortDelay=e,this.longDelay=n,me(n>e,"Short delay should be less than long delay!"),this.isMobile=pa()||_a()}get(){return Fc()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hc=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],$c=new Ft(3e4,6e4);function yi(i,e){return i.tenantId&&!e.tenantId?{...e,tenantId:i.tenantId}:e}async function lt(i,e,n,s,o={}){return Vr(i,o,async()=>{let c={},l={};s&&(e==="GET"?l=s:c={body:JSON.stringify(s)});const I=Vt({key:i.config.apiKey,...l}).slice(1),v=await i._getAdditionalHeaders();v["Content-Type"]="application/json",i.languageCode&&(v["X-Firebase-Locale"]=i.languageCode);const E={method:e,headers:v,...c};return ga()||(E.referrerPolicy="no-referrer"),i.emulatorConfig&&Ut(i.emulatorConfig.host)&&(E.credentials="include"),xr.fetch()(await Fr(i,i.config.apiHost,n,I),E)})}async function Vr(i,e,n){i._canInitEmulator=!1;const s={...Bc,...e};try{const o=new zc(i),c=await Promise.race([n(),o.promise]);o.clearNetworkTimeout();const l=await c.json();if("needConfirmation"in l)throw nn(i,"account-exists-with-different-credential",l);if(c.ok&&!("errorMessage"in l))return l;{const I=c.ok?l.errorMessage:l.error.message,[v,E]=I.split(" : ");if(v==="FEDERATED_USER_ID_ALREADY_LINKED")throw nn(i,"credential-already-in-use",l);if(v==="EMAIL_EXISTS")throw nn(i,"email-already-in-use",l);if(v==="USER_DISABLED")throw nn(i,"user-disabled",l);const b=s[v]||v.toLowerCase().replace(/[_\s]+/g,"-");if(E)throw Ur(i,b,E);ge(i,b)}}catch(o){if(o instanceof _e)throw o;ge(i,"network-request-failed",{message:String(o)})}}async function Wc(i,e,n,s,o={}){const c=await lt(i,e,n,s,o);return"mfaPendingCredential"in c&&ge(i,"multi-factor-auth-required",{_serverResponse:c}),c}async function Fr(i,e,n,s){const o=`${e}${n}?${s}`,c=i,l=c.config.emulator?_i(i.config,o):`${i.config.apiScheme}://${o}`;return Hc.includes(n)&&(await c._persistenceManagerAvailable,c._getPersistenceType()==="COOKIE")?c._getPersistence()._getFinalTarget(l).toString():l}class zc{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,s)=>{this.timer=setTimeout(()=>s(he(this.auth,"network-request-failed")),$c.get())})}}function nn(i,e,n){const s={appName:i.name};n.email&&(s.email=n.email),n.phoneNumber&&(s.phoneNumber=n.phoneNumber);const o=he(i,e,s);return o.customData._tokenResponse=n,o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pt(i){if(i)try{const e=new Date(Number(i));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function qc(i,e=!1){const n=ct(i),s=await n.getIdToken(e),o=wi(s);C(o&&o.exp&&o.auth_time&&o.iat,n.auth,"internal-error");const c=typeof o.firebase=="object"?o.firebase:void 0,l=c==null?void 0:c.sign_in_provider;return{claims:o,token:s,authTime:Pt(Zn(o.auth_time)),issuedAtTime:Pt(Zn(o.iat)),expirationTime:Pt(Zn(o.exp)),signInProvider:l||null,signInSecondFactor:(c==null?void 0:c.sign_in_second_factor)||null}}function Zn(i){return Number(i)*1e3}function wi(i){const[e,n,s]=i.split(".");if(e===void 0||n===void 0||s===void 0)return on("JWT malformed, contained fewer than 3 sections"),null;try{const o=Er(n);return o?JSON.parse(o):(on("Failed to decode base64 JWT payload"),null)}catch(o){return on("Caught error parsing JWT payload as JSON",o==null?void 0:o.toString()),null}}function Bs(i){const e=wi(i);return C(e,"internal-error"),C(typeof e.exp<"u","internal-error"),C(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Lt(i,e,n=!1){if(n)return e;try{return await e}catch(s){throw s instanceof _e&&Kc(s)&&i.auth.currentUser===i&&await i.auth.signOut(),s}}function Kc({code:i}){return i==="auth/user-disabled"||i==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jt extends Zr{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function yh(i,e,n=!1){const{auth:s}=i;if(ae(s.app))return Promise.reject($e(s));const o="reauthenticate";try{const c=await Lt(i,eo(s,o,e,i),n);C(c.idToken,s,"internal-error");const l=wi(c.idToken);C(l,s,"internal-error");const{sub:I}=l;return C(i.uid===I,s,"user-mismatch"),ot._forOperation(i,o,c)}catch(c){throw(c==null?void 0:c.code)==="auth/user-not-found"&&ge(s,"user-mismatch"),c}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hh="pendingRedirect",cn=new Map;class $h extends ho{constructor(e,n,s=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,s),this.eventId=null}async execute(){let e=cn.get(this.auth._key());if(!e){try{const s=await Wh(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(s)}catch(n){e=()=>Promise.reject(n)}cn.set(this.auth._key(),e)}return this.bypassAuthState||cn.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function Wh(i,e){const n=qh(e),s=Gh(i);if(!await s._isAvailable())return!1;const o=await s._get(n)==="true";return await s._remove(n),o}function zh(i,e){cn.set(i._key(),e)}function Gh(i){return fe(i._redirectPersistence)}function qh(i){return an(Hh,i.config.apiKey,i.name)}async function Kh(i,e,n=!1){if(ae(i.app))return Promise.reject($e(i));const s=vi(i),o=xh(s,e),l=await new $h(s,o,n).execute();return l&&!n&&(delete l.user._redirectEventId,await s._persistUserIfCurrent(l.user),await s._setRedirectUser(null,e)),l}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const at=new fi("@firebase/firestore");function ne(i,...e){if(at.logLevel<=O.DEBUG){const n=e.map(bi);at.debug(`Firestore (${Ht}): ${i}`,...n)}}function uo(i,...e){if(at.logLevel<=O.ERROR){const n=e.map(bi);at.error(`Firestore (${Ht}): ${i}`,...n)}}function Ll(i,...e){if(at.logLevel<=O.WARN){const n=e.map(bi);at.warn(`Firestore (${Ht}): ${i}`,...n)}}function bi(i){if(typeof i=="string")return i;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mt(i,e,n){let s="Unexpected state";typeof e=="string"?s=e:n=e,fo(i,s,n)}function fo(i,e,n){let s=`FIRESTORE (${Ht}) INTERNAL ASSERTION FAILED: ${e} (ID: ${i.toString(16)})`;if(n!==void 0)try{s+=" CONTEXT: "+JSON.stringify(n)}catch{s+=" CONTEXT: "+n}throw uo(s),new Error(s)}function Rt(i,e,n,s){let o="Unexpected state";typeof n=="string"?o=n:s=n,i||fo(e,o,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class We{constructor(e,n){if(!isFinite(e)||e<-90||e>90)throw new N(k.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(n)||n<-180||n>180)throw new N(k.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+n);this._lat=e,this._long=n}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return Le(this._lat,e._lat)||Le(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:We._jsonSchemaVersion}}static fromJSON(e){if($t(e,We._jsonSchema))return new We(e.latitude,e.longitude)}}We._jsonSchemaVersion="firestore/geoPoint/1.0",We._jsonSchema={type:j("string",We._jsonSchemaVersion),latitude:j("number"),longitude:j("number")};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yo{constructor(e,n,s,o,c){this._firestore=e,this._userDataWriter=n,this._key=s,this._document=o,this._converter=c}get id(){return this._key.path.lastSegment()}get ref(){return new ce(this._firestore,this._converter,this._key)}exists(){return this._document!==null}data(){if(this._document){if(this._converter){const e=new lu(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}get(e){if(this._document){const n=this._document.data.field(wo("DocumentSnapshot.get",e));if(n!==null)return this._userDataWriter.convertValue(n)}}}class lu extends yo{data(){return super.data()}}function wo(i,e){return typeof e=="string"?hu(i,e):e instanceof _o?e._internalPath:e._delegate._internalPath}class rn{constructor(e,n){this.hasPendingWrites=e,this.fromCache=n}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class st extends yo{constructor(e,n,s,o,c,l){super(e,n,s,o,l),this._firestore=e,this._firestoreImpl=e,this.metadata=c}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const n=new ln(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(n,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,n={}){if(this._document){const s=this._document.data.field(wo("DocumentSnapshot.get",e));if(s!==null)return this._userDataWriter.convertValue(s,n.serverTimestamps)}}toJSON(){if(this.metadata.hasPendingWrites)throw new N(k.FAILED_PRECONDITION,"DocumentSnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");const e=this._document,n={};return n.type=st._jsonSchemaVersion,n.bundle="",n.bundleSource="DocumentSnapshot",n.bundleName=this._key.toString(),!e||!e.isValidDocument()||!e.isFoundDocument()?n:(this._userDataWriter.convertObjectMap(e.data.value.mapValue.fields,"previous"),n.bundle=(this._firestore,this.ref.path,"NOT SUPPORTED"),n)}}st._jsonSchemaVersion="firestore/documentSnapshot/1.0",st._jsonSchema={type:j("string",st._jsonSchemaVersion),bundleSource:j("string","DocumentSnapshot"),bundleName:j("string"),bundle:j("string")};class ln extends st{data(e={}){return super.data(e)}}class Nt{constructor(e,n,s,o){this._firestore=e,this._userDataWriter=n,this._snapshot=o,this.metadata=new rn(o.hasPendingWrites,o.fromCache),this.query=s}get docs(){const e=[];return this.forEach(n=>e.push(n)),e}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(e,n){this._snapshot.docs.forEach(s=>{e.call(n,new ln(this._firestore,this._userDataWriter,s.key,s,new rn(this._snapshot.mutatedKeys.has(s.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){const n=!!e.includeMetadataChanges;if(n&&this._snapshot.excludesMetadataChanges)throw new N(k.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===n||(this._cachedChanges=function(o,c){if(o._snapshot.oldDocs.isEmpty()){let l=0;return o._snapshot.docChanges.map(I=>{const v=new ln(o._firestore,o._userDataWriter,I.doc.key,I.doc,new rn(o._snapshot.mutatedKeys.has(I.doc.key),o._snapshot.fromCache),o.query.converter);return I.doc,{type:"added",doc:v,oldIndex:-1,newIndex:l++}})}{let l=o._snapshot.oldDocs;return o._snapshot.docChanges.filter(I=>c||I.type!==3).map(I=>{const v=new ln(o._firestore,o._userDataWriter,I.doc.key,I.doc,new rn(o._snapshot.mutatedKeys.has(I.doc.key),o._snapshot.fromCache),o.query.converter);let E=-1,b=-1;return I.type!==0&&(E=l.indexOf(I.doc.key),l=l.delete(I.doc.key)),I.type!==1&&(l=l.add(I.doc),b=l.indexOf(I.doc.key)),{type:uu(I.type),doc:v,oldIndex:E,newIndex:b}})}}(this,n),this._cachedChangesIncludeMetadataChanges=n),this._cachedChanges}toJSON(){if(this.metadata.hasPendingWrites)throw new N(k.FAILED_PRECONDITION,"QuerySnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");const e={};e.type=Nt._jsonSchemaVersion,e.bundleSource="QuerySnapshot",e.bundleName=Hl.newId(),this._firestore._databaseId.database,this._firestore._databaseId.projectId;const n=[],s=[],o=[];return this.docs.forEach(c=>{c._document!==null&&(n.push(c._document),s.push(this._userDataWriter.convertObjectMap(c._document.data.value.mapValue.fields,"previous")),o.push(c.ref.path))}),e.bundle=(this._firestore,this.query._query,e.bundleName,"NOT SUPPORTED"),e}}function uu(i){switch(i){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return Mt(61501,{type:i})}}Nt._jsonSchemaVersion="firestore/querySnapshot/1.0",Nt._jsonSchema={type:j("string",Nt._jsonSchemaVersion),bundleSource:j("string","QuerySnapshot"),bundleName:j("string"),bundle:j("string")};(function(e,n=!0){(function(o){Ht=o})(ht),rt(new qe("firestore",(s,{instanceIdentifier:o,options:c})=>{const l=s.getProvider("app").getImmediate(),I=new ou(new xl(s.getProvider("auth-internal")),new jl(l,s.getProvider("app-check-internal")),function(E,b){if(!Object.prototype.hasOwnProperty.apply(E.options,["projectId"]))throw new N(k.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new wn(E.options.projectId,b)}(l,o),l);return c={useFetchStreams:n,...c},I._setSettings(c),I},"PUBLIC").setMultipleInstances(!0)),De(sr,rr,e),De(sr,rr,"esm2020")})();var du="firebase",fu="12.4.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */De(du,fu,"app");const Ot={apiKey:"AIzaSyC2r1nUf2eT9GMa2Mb5XOy2MOVFs39Gttk",authDomain:"webgis-deliserdang.firebaseapp.com",projectId:"webgis-deliserdang",storageBucket:"webgis-deliserdang.firebasestorage.app",messagingSenderId:"178538591157",appId:"1:178538591157:web:08c55fa9443970ed1b5ffc",measurementId:"G-VG6MF0WV9V"};if(!Ot.apiKey||!Ot.authDomain||!Ot.projectId)throw console.error("❌ Missing Firebase configuration. Please check your environment variables."),new Error("Firebase configuration is missing");console.log("Initializing Firebase with config:",Ot);const Io=kr(Ot),pu=Ol(Io),gu=au(Io);console.log("Firebase initialized successfully");console.log("Auth object:",pu);console.log("DB object:",gu);
